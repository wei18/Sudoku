...
| N23 | Restore Purchases — empty result | "Purchases restored" success toast even when nothing was restorable — no dedicated "nothing to restore" message (UX gap, unfiled; note for a future polish pass) | `LiveStoreKit2IAPClient.swift:122`, `MonetizationStateController.swift:216-227` — **OUT of E2E scope** (#935 batch 5): pinning this in an E2E test would lock in a documented UX gap that a future polish pass intentionally changes; unit scope |
