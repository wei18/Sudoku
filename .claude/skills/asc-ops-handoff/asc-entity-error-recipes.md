...
|---|---|---|---|
| `LOCALE_INVALID` | Apple rejects the leaderboard/achievement locale code | In `Strings/*.xcstrings` + Config.swift locale lists: use `zh-Hant` (no region), not `zh-Hant-TW`; `en` (no region) where applicable | #31 #37 |
