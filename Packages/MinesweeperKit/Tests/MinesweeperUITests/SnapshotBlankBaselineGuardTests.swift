...
//
// Mirror of SudokuKit's guard (the two test targets are separate packages with
// no shared test-helper target, the same reason `SnapshotConfig.swift` is
...
@Suite("Snapshot baselines — none may be blank (Minesweeper)")
