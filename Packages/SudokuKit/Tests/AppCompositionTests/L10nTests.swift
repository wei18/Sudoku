...
struct L10nTests {
    ...
    private static func catalogURL() throws -> URL {
        // Resolves to the bundled fixture `Resources/Localizable.xcstrings.json`,
        // a mechanically-generated byte-copy of the shipping catalog
        // `App/Sudoku/Resources/Localizable.xcstrings` (regenerate via
        // `mise run gen:l10n_fixture`; drift blocked by the `scan:l10n` gate —
        // issue #394). Bundle.module finds it wherever the test bundle is
        // installed — including Xcode Cloud's distributed Build/Test split
        // where the source tree isn't on the test runner.
